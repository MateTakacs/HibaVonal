...
export const getMaintainerIssues = async ({ status } = {}) =>
  getWithDeduplication("/api/maintainer/issues", buildParams({ status }));

export const getMaintainerIssueById = async (id) =>
  getWithDeduplication(`/api/maintainer/issues/${id}`);
...
export const getMaintainerOrders = async ({ status } = {}) =>
  getWithDeduplication("/api/maintainer/orders", buildParams({ status }));
...
export const getLeadMaintainerIssues = async ({
  status,
  onlyUnassigned,
} = {}) =>
  getWithDeduplication(
    "/api/lead-maintainer/issues",
    buildParams({ status, onlyUnassigned }),
  );

export const getLeadMaintainerIssueById = async (id) =>
  getWithDeduplication(`/api/lead-maintainer/issues/${id}`);

export const getMaintainers = async () =>
  getWithDeduplication("/api/lead-maintainer/maintainers");
