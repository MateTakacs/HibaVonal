              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <strong>
                      {selectedUser.roomNum 
                        ? `${selectedUser.roomNum}. szoba` 
                        : "Nincs megadva"
                      }
                    </strong>
                  </li>
                  ...
                  >
                    <span>
                      Bejelentett hibák (összesen):
                    </span>
                    <span 
                      className="badge bg-danger rounded-pill"
                    >
                      {selectedUser.reportedIssuesCount} db
                    </span>
                  </li>
                  
                  {(selectedUser.role === ROLES.MAINTAINER || 
                    selectedUser.role === ROLES.LEAD_MAINTAINER) && (
                    <li 
                      className="list-group-item d-flex justify-content-between align-items-center px-0"
                    >
                      <span>
                      ...
                      >
                        {selectedUser.assignedIssuesCount} db
                      </span>
                    </li>
                  )}
                </ul>
