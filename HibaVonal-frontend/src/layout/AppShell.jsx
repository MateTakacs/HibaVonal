...
const AppShell = ({
  ...
  subtitle,
  children,
  brandTitle = "Karbantartási felület",
  brandSubtitle = "Hibajegyek, kiosztások és eszközrendelések kezelése a meglévő backenddel.",
}) => {
        ...
        <aside className="col-12 col-lg-3 col-xl-2 app-sidebar">
          <div className="sidebar-content">
            <div>
              ...
              <h1 className="sidebar-title">{brandTitle}</h1>
